...
const UserMessage = lazy(() => import("./UserMessage/UserMessage.jsx"));
const AiMessage = lazy(() => import("./AiMessage/AiMessage"));
        ...
        <div>
          {messages.map((m, index) => {
            return index % 2 === 0 ? (
              ...
              <AiMessage key={index} message={m} arrayIndex={index} />
            );
          })}
